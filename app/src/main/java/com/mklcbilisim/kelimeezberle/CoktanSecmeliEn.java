...
public class CoktanSecmeliEn extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coktan_secmeli_en);
        ...
        new CountDownTimer(1000,1000){
            ...
            public void onFinish() {
                ...
                if(randomKelime != ezberEn.length-1){
                    ...
                    Intent enSayfa = new Intent(CoktanSecmeliEn.this,YazmaTesti.class);
