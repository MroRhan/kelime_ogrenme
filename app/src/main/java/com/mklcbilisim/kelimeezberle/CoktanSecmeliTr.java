...
public class CoktanSecmeliTr extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coktan_secmeli_tr);
    ...
    protected void kelimeSor(int hangiKelime){
        System.out.println(tumTr.length);
        ...
        new CountDownTimer(1000,1000){
            ...
            public void onFinish() {
              ...
              //      System.out.println(randomKelime);
                    ...
                    Intent enSayfa = new Intent(CoktanSecmeliTr.this,CoktanSecmeliEn.class);
    ...
    public void hataYaptim(String kelime){
        ...
        try {
            ...
            SQLiteDatabase database = this.openOrCreateDatabase("Kelimeler",MODE_PRIVATE,null);
            String guncelleSrgu = "UPDATE kelimeler SET S1 = 1 WHERE kelimeing = '" + kelime + "'";
            System.out.println(kelime);
