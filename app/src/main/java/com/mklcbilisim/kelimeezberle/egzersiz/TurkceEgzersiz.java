...
public class TurkceEgzersiz extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egzersiz_turkce);
        ...
        new CountDownTimer(1000,1000){
            ...
            public void onFinish() {
                ...
                if(randomKelime != ezberEn.length-1){
                    ...
                    Intent enSayfa = new Intent(TurkceEgzersiz.this,TurkceEgzersiz.class);
