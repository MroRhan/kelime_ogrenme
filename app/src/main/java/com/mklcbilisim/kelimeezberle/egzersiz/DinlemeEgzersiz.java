...
import com.mklcbilisim.kelimeezberle.KonusmaTesti;
import com.mklcbilisim.kelimeezberle.R;

import java.util.Locale;
import java.util.Random;

public class DinlemeEgzersiz extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egzersiz_dinleme);
