...
import com.mklcbilisim.kelimeezberle.DinlemeTesti;
...
public class SiralamaEgzersiz extends AppCompatActivity implements TextToSpeech.OnInitListener,View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egzersiz_siralama);
